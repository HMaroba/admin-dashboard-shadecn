...
import { FaUsers, FaFolder, FaCog, FaChevronDown, FaBars, FaTimes } from 'react-icons/fa'
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    <tr>
                      ...
                      <td className="whitespace-nowrap px-4 py-4 md:px-6">john@example.com</td>
                      <td className="whitespace-nowrap px-4 py-4 md:px-6">Admin</td>
                    ...
                    <tr>
                      ...
                      <td className="whitespace-nowrap px-4 py-4 md:px-6">jane@example.com</td>
                      <td className="whitespace-nowrap px-4 py-4 md:px-6">User</td>
                      <td className="whitespace-nowrap px-4 py-4 md:px-6">
                        <button className="rounded bg-blue-500 px-2 py-1 text-sm font-bold text-white hover:bg-blue-700 md:px-4 md:py-2">Edit</button>
                      </td>
                    </tr>
